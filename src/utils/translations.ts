export const translations = {
    ...
    userProfile: {
      ...
      features: {
        phr: {
          ...
          description: "Centralize & access your full medical history in seconds."
        },
        telemedicine: {
          title: "Telemedicine", 
          description: "Connect with licensed providers anywhere, anytime."
        },
        ai: {
          title: "AI‑Powered Insights",
          description: "Get proactive health alerts & personalized care tips."
        }
      }
    },
    features: {
      ...
      cards: {
        unite: {
          ...
          description: "Centralize your entire medical history from every clinic and hospital into one secure, accessible app."
        },
        security: {
      ...
      features: [
        {
          ...
          description: "Mi-Health securely transmits encrypted practice data from your system to the application."
        },
        {
          title: "No Misuse Of Your Data", 
          description: "Mi-Health does not misuse your personal record data. Your data remains in your control."
        },
        {
        ...
        },
        {
          ...
          description: "Mi-Health allows you to view all access to your applications at any time."
        },
        {
          title: "Tested And Recommended By Experts",
          description: "Mi-Health is regularly audited for security and data protection and actively involves experts."
        }
      ],
      footer: "We do everything to ensure the best possible security and complete data protection.",
      learnMore: "More about security and data protection"
    },
    pricing: {
  ...
  fr: {
    ...
    userProfile: {
      ...
      features: {
        phr: {
          title: "Dossiers de Santé Personnels",
          description: "Centralisez et accédez à votre historique médical complet en quelques secondes."
        },
        telemedicine: {
          title: "Télémédecine",
          description: "Connectez-vous avec des prestataires agréés n'importe où, n'importe quand."
        },
        ai: {
          title: "Insights Alimentés par l'IA",
          description: "Obtenez des alertes de santé proactives et des conseils de soins personnalisés."
        }
      }
    },
    features: {
      ...
      cards: {
        unite: {
          ...
          description: "Centralisez tout votre historique médical de chaque clinique et hôpital dans une seule application sécurisée et accessible."
        },
        security: {
    ...
    security: {
      ...
      features: [
        {
          title: "Transfert de Données Sécurisé",
          description: "Mi-Health transmet de manière sécurisée les données de pratique chiffrées de votre système vers l'application."
        },
        {
          title: "Aucune Utilisation Abusive de Vos Données",
          description: "Mi-Health n'abuse pas de vos données de dossier personnel. Vos données restent sous votre contrôle."
        },
        {
        ...
        },
        {
          ...
          description: "Mi-Health vous permet de voir tous les accès à vos applications à tout moment."
        },
        {
          title: "Testé et Recommandé par des Experts",
          description: "Mi-Health est régulièrement audité pour la sécurité et la protection des données et implique activement des experts."
        }
      ],
      footer: "Nous faisons tout pour assurer la meilleure sécurité possible et une protection complète des données.",
      learnMore: "En savoir plus sur la sécurité et la protection des données"
    },
    pricing: {
      ...
      plans: {
        individual: {
          ...
          description: "Parfait pour la gestion de santé personnelle.",
          features: [
            "Fonctionnalités DSP de base",
        ...
        pro: {
          ...
          features: [
            ...
            "Intégration DSE transparente",
            "Outils d'analyse et de rapport de données",
            "Support prioritaire"
          ]
        },
        limitless: {
